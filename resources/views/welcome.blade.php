...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased p-8 lg:p-10 lg:px-48">
        <div class="w-full flex items-center justify-between p-2 pb-5">
            <div class="flex items-baseline gap-12 divide-x-2">
                <div class="text-red-600 font-bold text-3xl">
                    Arewa.
                </div>

                <nav class="hidden lg:flex px-4 gap-x-5">
                    <div class="text-gray-800 transition font-medium">
                        <a href="/">Home</a>
                    </div>

                    <div class="text-gray-700 hover:text-gray-800 transition">
                        <a href="/">Articles</a>
                    </div>
                    ...
                    <div class="text-gray-700 hover:text-gray-800 transition">
                        <a href="/">Drop a message</a>
                    </div>
                </nav>
            </div>

            <div class="flex items-center justify-end gap-x-5">
                <div class="text-gray-700 hover:text-gray-800 hover:font-medium transition">
        ...
        <div class="w-full py-24 lg:py-48 bg-gray-100 rounded-3xl flex flex-col items-center justify-center" style="background: url('./resources/img/bg-hero.jpg')">
            <h3 class="text-gray-800 text-lg font-medium font-montserrat tracking-widest">Welcome to Arewa Diary</h3>
            <div class="w-full lg:w-1/2 mx-auto text-center mt-5">
                <h2 class="hero-section-heading text-3xl lg:text-5xl font-bold text-gray-800 tracking-widest">
                    We craft <span>narratives</span>
                    <i class="fa-solid fa-feather"></i> that ignite
                    <span>inspiration</span>, <span>knowledge</span>, and <span>entertainment</span>
                </h2>
            </div>
        </div>

        <div class="w-full flex items-center flex-col lg:flex-row my-24 px-1">

            <div class="w-full lg:w-2/5 lg:me-5 ">
                <div class="featured-post-image bg-orange-500 rounded-xl h-[200pt] lg:h-[400pt] flex items-center justify-center">

                </div>
            </div>

            <div class="w-full lg:w-3/5 lg:ps-10 pt-10">
                <div class="flex items-center gap-x-4 font-medium text-sm lg:text-lg divide-x-2 text-gray-700">
                    ...
                    <h2 class="font-serif text-gray-900 text-3xl lg:text-7xl font-semibold my-6">Where to watch 'John Wick: Chapter 4'</h2>
                    <div class="text-lg text-gray-700 grid gap-y-4">
                        <p>
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatum exercitationem ex aperiam molestiae odit suscipit in tempora tenetur obcaecati fuga quas ab, incidunt, nesciunt aspernatur et expedita itaque possimus fugit!
                        </p>
                        <p>
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Id dolore distinctio nesciunt perspiciatis similique explicabo dicta molestias reprehenderit, ratione voluptatibus voluptatem totam natus velit suscipit veritatis, tempora illo repellat architecto!
                        </p>
                    </div>
                    <div class="flex items-center mt-5 text-gray-700 gap-x-4 divide-x-2 font-medium">
                        <span class="text-red-600">Movies</span>
                        <span class="pl-3">4 minutes read</span>
                        <span class="pl-3 text-red-600">Read More...</span>
                    </div>
                </div>
        ...
        <div class="grid gap-y-3">
            <div class="flex gap-y-4 items-center justify-between">
                <h3 class="font-montserrat text-4xl font-bold">
                    Recent Articles
                </h3>

                <a href="/blog" class="font-bold text-lg text-red-600">See all</a>
            </div>
            <div class="grid gid-cols-1 lg:grid-cols-4 gap-2 gap-y-6">
                <div class="grid gap-y-3 rounded-t-3xl border shadow">
                    <img src="/resources/img/blog-default.jpg" class="mx-auto rounded-3xl h-[200pt] lg:w-[400pt]" alt="">
                    <div class="p-2">
                        <div class="flex items-center gap-x-2 font-semibold text-gray-700 text-lg">
                            <img src="{{asset('resources/img/blog-default.jpg')}}" class="h-8 w-8 rounded-full" alt="">
                            <div class="flex flex-col lg:flex-row divide-x-2 gap-3">
                                <span>
                                    Category 1
                                </span>
                                <span class="pl-3 font-medium">
                                    3 hours ago
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="px-2 pb-4">
                        <h4 class="text-3xl font-bold font-montserrat text-gray-800">Title of first article</h4>
                        <p class="text-gray-700 text-justify pe-2 pt-2">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum aspernatur nemo eos consectetur repellendus placeat illo ab minus ipsa, ex tempore vero, sint nobis eaque nisi! Fugiat saepe perspiciatis laudantium.
                        </p>
                    </div>
                </div>
            </div>
